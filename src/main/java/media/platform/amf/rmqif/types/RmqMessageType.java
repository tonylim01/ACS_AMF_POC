...
public class RmqMessageType {
    ...
    public static final int RMQ_MSG_COMMON_REASON_CODE_FAILURE = 1004;
    public static final int RMQ_COMMON_REASON_CODE_TIMEOUT = 1002;
    public static final int RMQ_MSG_COMMON_REASON_CODE_WRONG_PARAM = 1000;
    public static final int RMQ_MSG_COMMON_REASON_CODE_ALREADY_EXIST = 1003;
    public static final int RMQ_MSG_COMMON_REASON_CODE_RESOURCE_FULL = 2001;
