...
public class RedunProcAiServiceCancelReq implements RedunProcMessageHandler {

    private static final Logger logger = LoggerFactory.getLogger(RedunProcAiServiceCancelReq.class);
    ...
    public boolean handle(String body) {
        ...
        logger.debug("<- Redundant (AiServiceCancelReq): sessionId [{}]", fromSessionInfo.getSessionId());
