    ...
    private void handleMessage(byte[] data) {
        ...
        switch ((int)msgType) {
            ...
            case RedundantMessage.RMT_SN_UPDATE_JITTER_SENDER_REQ:
                ...
                break;
            case RedundantMessage.RMT_SN_WAKEUP_STATUS_REQ:
                RedunProcWakeupStatusReq wakeupStatusReq = new RedunProcWakeupStatusReq();
                wakeupStatusReq.handle(body);
                break;
            case RedundantMessage.RMT_SN_AI_SERVICE_RES:
                RedunProcAiServiceRes aiServiceRes = new RedunProcAiServiceRes();
                aiServiceRes.handle(body);
                break;
            case RedundantMessage.RMT_SN_AI_SERVICE_CANCEL_REQ:
                RedunProcAiServiceCancelReq aiServiceCancelReq = new RedunProcAiServiceCancelReq();
                aiServiceCancelReq.handle(body);
                break;
            case RedundantMessage.RMT_SN_LOGIN_RES:
