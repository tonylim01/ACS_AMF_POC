...
//                System.out.println("Session list " + session + " input " + sessionId);
    ...
    public void setWakeupStatus(int wakeupStatus) {
        ...
        logger.debug("setWakeupStatus. status [{}]", wakeupStatus);
    ...
    public String getAwfCallId() {
        return awfCallId;
    }

    public void setAwfCallId(String awfCallId) {
        this.awfCallId = awfCallId;
    }
