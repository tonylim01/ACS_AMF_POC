...
public class EngineServiceManager {
    ...
    public static EngineServiceManager getInstance(int index) {
        if (engineServiceManager == null) {
            engineServiceManager = new EngineServiceManager(index);
        }
    ...
    public EngineServiceManager(int index) {
        this.index = index;
    ...
    public void start() {
        ...
        client = EngineClient.getInstance(index);

        logger.info("EngineServiceManager started");
    }
